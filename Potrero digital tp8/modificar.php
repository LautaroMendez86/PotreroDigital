...
<html lang="en">
    ...
    <body>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="tipo" placeholder="Tipo de Prenda" value="<?php echo "$tipo"; ?>"> /dentro del value ponemos el dato que que trajimos del egistro para que ya aparezca el el imput y no volver aq escribirlo
            <label>Marca</label>
