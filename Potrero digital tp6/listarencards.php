...
<body>
  ...
  <button type="submit"><a href="listarNike.php">Listar ropa Nike</a></button>
  <button type="submit"><a href="listarBuzos.php">Listar Buzos</a></button>
  <button type="submit"><a href="listarPrecio.php">Listar Mayor a 500</a></button>
